...
/**
 * PrintSettingsFragment - Sunmi Built-in Printer detection + ZATCA invoice settings
...
class PrintSettingsFragment : Fragment() {
    ...
    private fun setupViews(view: View) {
        ...
        rgPrintMethod?.setOnCheckedChangeListener { _, checkedId ->
            layoutNetworkPrinter?.visibility = if (checkedId == R.id.rbNetworkPrinter) View.VISIBLE else View.GONE
        }
