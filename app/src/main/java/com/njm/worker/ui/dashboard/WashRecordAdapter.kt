 ...
 * Design v2: Navy/Gold color scheme
...
class WashRecordAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        // Navy/Gold design: paid = gold, unpaid = navy
        holder.tvPayStatus.setTextColor(
            if (isPaid) Color.parseColor("#c8962f") else Color.parseColor("#0f3460")
        )
        ...
        // Color-code card: paid = white, unpaid = light gold tint
